...
define dso_local i32 @main() local_unnamed_addr #0 {;                     preheader_2
...
4:                                                ; preds = %12, %0;      header_1, preheader_2
  %5 = phi i32 [ 1, %0 ], [ %13, %12 ]
  br label %6

6:                                                ; preds = %6, %4;       header_2, latch_2
  %7 = phi i32 [ 2, %4 ], [ %9, %6 ]
  %8 = call i32 (i8*, ...) @printf(i8* noundef nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i32 noundef %5, i32 noundef %7)
  %9 = add nuw nsw i32 %7, 1
  %10 = load i32, i32* %1, align 4, !tbaa !3
  %11 = icmp slt i32 %7, %10
  br i1 %11, label %6, label %12, !llvm.loop !7

12:                                               ; preds = %6;           latch_1, exitBB_2
  %13 = add nuw nsw i32 %5, 1
  %14 = icmp slt i32 %5, %10
  br i1 %14, label %4, label %15, !llvm.loop !10

15:                                               ; preds = %12;          exitBB_1

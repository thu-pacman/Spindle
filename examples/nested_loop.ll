...
; Function Attrs: nofree nounwind uwtable;      `*` stands for memory access instruction
define dso_local i32 @main() local_unnamed_addr #0 {
  %1 = tail call i32 (i8*, ...) @__isoc99_scanf(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32* noundef nonnull @n)  
                                                  ; *
  %2 = load i32, i32* @n, align 4, !tbaa !3       ; * global_vars
  %3 = icmp sgt i32 %2, 0
  br i1 %3, label %4, label %9

4:                                                ; preds = %0;         preheader_1
  %5 = zext i32 %2 to i64
  br label %6

6:                                                ; preds = %10, %4;    header_1, preheader_2
  %7 = phi i32 [ 0, %4 ], [ %11, %10 ]
  %8 = sub i32 %2, %7
  br label %13

9:                                                ; preds = %10, %0;    exitBB_1
  ret i32 0

10:                                               ; preds = %13;        latch_1, exitBB_2
  %11 = add nuw nsw i32 %7, 1
  %12 = icmp eq i32 %11, %2
  br i1 %12, label %9, label %6, !llvm.loop !7

13:                                               ; preds = %6, %13;    header_2, latch_2
  ...
  %22 = icmp eq i64 %21, %5
  br i1 %22, label %10, label %13, !llvm.loop !10
}
